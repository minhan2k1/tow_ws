...
int main(int argc, char** argv){
    ros::init(argc, argv, "robot_stand");

    std::map<std::string, double> target_position;
    
    target_position["j_flhr"] = 0;
    target_position["j_flhp"] = -0.66;
    target_position["j_flkp"] = 0.8;
    target_position["j_rlhr"] = 0;
    target_position["j_rlhp"] = -0.66;
    target_position["j_rlkp"] = 0.8;
    target_position["j_frhr"] = 0;
    target_position["j_frhp"] = -0.66;
    target_position["j_frkp"] = 0.8;
    target_position["j_rrhr"] = 0;
    target_position["j_rrhp"] = -0.66;
    target_position["j_rrkp"] = 0.8;
